...
import { recordSchema, scrub, validate } from "@/lib/validation";
...
function RecordsPage() {
  ...
  const submit = () => {
    const data = validate(recordSchema, form);
    if (!data) return;
    db.addRecord(data as any);
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <Select
                    ...
                    onValueChange={(v) => setForm({ ...form, consultationId: v })}
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setForm({ ...form, diagnosis: scrub(e.target.value) })}
                  />
                </div>
                <div className="space-y-1.5">
