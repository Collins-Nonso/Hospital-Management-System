    ...
    <div className="space-y-6">
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="mt-2 space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button type="button" variant="ghost" size="sm" onClick={() => setMeds([...meds, emptyMed()])}><Plus className="mr-1 h-3.5 w-3.5" />Add</Button>
                </div>
                {meds.map((m, i) => (
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {prescriptions.map((rx) => {
          ...
          const doc = doctors.find((x) => x.id === rx.doctorId);
          return (
              ...
              <div className="mb-2 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">
                    Prescribed by {doc ? `${doc.firstName} ${doc.lastName}` : "—"} · {new Date(rx.createdAt).toLocaleDateString()}
                  </div>
                </div>
