...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Modern hospital management dashboard for clinical, lab, pharmacy and billing operations." },
      { property: "og:title", content: "MediCore Hospital Management" },
      { property: "og:description", content: "Modern hospital management dashboard for clinical, lab, pharmacy and billing operations." },
